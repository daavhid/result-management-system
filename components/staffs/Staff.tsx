                ...
                className=' p-8 flex flex-col gap-2 rounded-lg' >
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <Select onValueChange={field.onChange}  defaultValue={field.value}>
                                <FormControl>
                                    <SelectTrigger className='w-full bg-[#D9D9D9]/10  ring-tone7  border-none ring-1 outline-none focus-visible:ring-offset-3 focus-visible:ring-1'>
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <FormControl >
                                <Input className='w-full bg-[#D9D9D9]/10  ring-tone7  border-none ring-1 outline-none focus-visible:ring-offset-3 focus-visible:ring-1 ' placeholder='Enter Last Name'  {...field}  />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <FormControl >
                                <Input  className='w-full bg-[#D9D9D9]/10  ring-tone7  border-none ring-1 outline-none focus-visible:ring-offset-3 focus-visible:ring-1 ' type='email' placeholder='Enter Email'  {...field}  />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                            ...
                            <Popover>
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        ...
                                        role="combobox"
                                        aria-expanded={open}
                                        className="w-[200px] bg-[#D9D9D9]/10  ring-tone7  justify-between"
                                        >
                                        {field.value
                    ...
                    <Button type='submit' variant={'auth'} className='bg-tone7  w-fit rounded-md mt-6 py-5   z-40 text-white text-xl' >Add</Button>
