    ...
    useEffect(()=>{
        const fetch = async()=>{
            ...
            if(user){
                ...
                if(resultData){
                    console.log(resultData,'thi iss the result daa')
    ...
    <div className='flex flex-col gap-6'>
        ...
        </Select>
        {
            ...
            <div ref={printRef} className='relative print:overflow-hidden print:h-screen'>
                <div className='absolute top-52 left-1/2 -translate-x-[50%] opacity-10  '>
                ...
                <div className='w-5/6 uppercase mx-auto flex relative z-20  justify-between my-8'>
                        <div>
                    ...
                    <h1 className='text-center text-xl underline my-3 print:mt-16'>Student Result</h1>
