                ...
                className=' p-8 flex flex-col gap-2 rounded-lg' >
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <Select onValueChange={field.onChange} value={field.value} defaultValue={field.value} >
                                <FormControl>
                                    <SelectTrigger className='bg-[#D9D9D9]/10 ring-1 ring-tone7 text-muted-foreground'>
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <FormControl >
                                <Input  className='w-full border-none ring-1 ring-tone7 outline-none focus-visible:ring-offset-3 focus-visible:ring-1 bg-[#D9D9D9]/10' placeholder='Enter code' type='number'  {...field}  />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}/>
                    ...
                    render={({field})=>(
                        <FormItem>
                            ...
                            <FormControl >
                                <Input  className='w-full border-none ring-1 ring-tone7 outline-none focus-visible:ring-offset-3 focus-visible:ring-1 bg-[#D9D9D9]/10' placeholder='introduction to code'  {...field}  />
                            </FormControl>
                            <FormMessage/>
                        </FormItem>
                    )}/>
                    
                    <Button type='submit' variant={'auth'} className=' w-fit rounded-md mt-6 py-5  bg-tone6 z-40 text-white text-xl' >Add</Button>
